...
local globalkeys = gears.table.join(
  ...
  awful.key({ modkey, }, "i", function() awful.spawn(terminal .. " start htop") end,
    { description = "launch htop", group = "applications" }),
  awful.key({ modkey, }, "m", function() awful.spawn(terminal .. " start neomutt") end,
    { description = "launch mail", group = "applications" }),
  awful.key({ modkey, }, "n", function() awful.spawn(terminal .. " start newsboat") end,
  ...
  awful.key({ modkey, }, "v", function() awful.spawn(terminal .. " start " .. os.getenv("EDITOR")) end,
